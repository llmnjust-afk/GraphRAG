...
def retrieve_global(question, graph, passage_map, communities=None, community_summaries=None):
    ...
    # --- BONUS: Community summary re-ranking (ADDS to dual scores, never replaces) ---
...
# ============================================================
# Global QA Generation
# ============================================================
def generate_global_questions(passages, n_questions=20):
    """Generate global/abstract questions about the corpus using LLM."""
...
def run_dataset(ds_name, config):
    ...
    global_questions = generate_global_questions(passages, n_questions=20)
